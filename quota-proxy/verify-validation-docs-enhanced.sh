...
check_ref "VALIDATION-QUICK-INDEX.md" "verify-env-vars.sh" "环境变量验证脚本"
check_ref "VALIDATION-QUICK-INDEX.md" "verify-json-logger-enhanced.sh" "JSON日志增强验证脚本"
check_ref "VALIDATION-QUICK-INDEX.md" "LOG-LEVEL-CONTROL.md" "日志级别控制指南"
check_ref "VALIDATION-QUICK-INDEX.md" "STRUCTURED-LOG-EXAMPLES.md" "结构化日志示例"
...
docs_to_check=(
    ...
    "LOG-LEVEL-CONTROL.md:20"
    "STRUCTURED-LOG-EXAMPLES.md:30"
