...
if grep -q "VALIDATION-EXAMPLES.md" "VALIDATION-QUICK-INDEX.md"; then
    echo "✅ VALIDATION-QUICK-INDEX.md 引用了 VALIDATION-EXAMPLES.md"
else
    echo "⚠️  VALIDATION-QUICK-INDEX.md 未引用 VALIDATION-EXAMPLES.md"
fi
